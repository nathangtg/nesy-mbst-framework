...
\begin{frame}{The MBST Bottleneck}
  \begin{columns}[T]
    ...
    \column{0.42\textwidth}
      \begin{tikzpicture}[->, >=stealth', auto, semithick, node distance=2.4cm, scale=0.9, transform shape]
        \tikzstyle{state}=[circle, draw, minimum size=1.0cm, inner sep=0pt, font=\small]
        \tikzstyle{terminal}=[rectangle, rounded corners, draw, minimum size=0.7cm, inner sep=3pt, font=\small]
    ...
    \column{0.47\textwidth}
      \begin{tikzpicture}[
          ...
          engine/.style={rectangle, draw=blue!60!black, rounded corners=2pt,
              fill=blue!7, minimum width=2.6cm, minimum height=0.8cm,
              text width=2.4cm, align=center, line width=0.6pt},
          oracle/.style={rectangle, draw=green!60!black, rounded corners=2pt,
              fill=green!7, minimum width=2.6cm, minimum height=0.8cm,
              text width=2.4cm, align=center, line width=0.6pt},
          sut/.style={rectangle, draw=red!60!black, rounded corners=2pt,
              fill=red!7, minimum width=2.6cm, minimum height=0.8cm,
              text width=2.4cm, align=center, line width=0.6pt},
          topo/.style={rectangle, draw=yellow!70!black, rounded corners=2pt,
              fill=yellow!12, minimum width=2.6cm, minimum height=0.7cm,
              text width=2.4cm, align=center, line width=0.6pt},
          solver/.style={rectangle, draw=orange!70!black, rounded corners=2pt,
              fill=orange!8, minimum width=2.6cm, minimum height=0.8cm,
              text width=2.4cm, align=center, line width=0.6pt},
          outnode/.style={rectangle, draw=violet!60!black, rounded corners=2pt,
              fill=violet!7, minimum width=2.6cm, minimum height=0.8cm,
              text width=2.4cm, align=center, line width=0.6pt},
          arr/.style={->, thick},
      ...
      \node[oracle]  (oracle) at (3.8, 0)    {Grammar-Constr.\\LLM Oracle};
      \node[sut]     (sut)    at (3.8,-1.9)  {SUT Execution\\Validation};
